...
Code Component Description : This code is client side for the Raspberry Pi Node. 
                             This program will fetch information from MQTT.
                             Upon doing this the program will use the status sent by mqtt to 
...
################## RASPBERRY-PI CODE ######################### 
#####GPIO 
GPIO_pin =7      #Enter as per Yash #Pin connect to LED 
